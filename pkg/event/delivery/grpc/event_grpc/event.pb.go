...
func init() {
	proto.RegisterType((*Event)(nil), "event_grpc.Event")
	proto.RegisterType((*CreateRequest)(nil), "event_grpc.CreateRequest")
	proto.RegisterType((*CreateResponse)(nil), "event_grpc.CreateResponse")
	proto.RegisterType((*ReadRequest)(nil), "event_grpc.ReadRequest")
	proto.RegisterType((*ReadResponse)(nil), "event_grpc.ReadResponse")
	proto.RegisterType((*UpdateRequest)(nil), "event_grpc.UpdateRequest")
	proto.RegisterType((*UpdateResponse)(nil), "event_grpc.UpdateResponse")
	proto.RegisterType((*DeleteRequest)(nil), "event_grpc.DeleteRequest")
	proto.RegisterType((*DeleteResponse)(nil), "event_grpc.DeleteResponse")
}
...
var fileDescriptor_2d17a9d3f0ddf27e = []byte{
	...
	,
}
...
// EventServiceClient is the client API for EventService worker.
//
...
func (c *eventServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/event_grpc.EventService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventServiceClient) Read(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*ReadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/event_grpc.EventService/Read", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventServiceClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/event_grpc.EventService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/event_grpc.EventService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// EventServiceServer is the server API for EventService worker.
...
func _EventService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event_grpc.EventService/Create",
	}
...
func _EventService_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event_grpc.EventService/Read",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EventService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event_grpc.EventService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EventService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/event_grpc.EventService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _EventService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "event_grpc.EventService",
